...
if (!isset($_SESSION['nombre'])) {
    ...
    // Verificación de acceso al escritorio
    if (isset($_SESSION['escritorio']) && $_SESSION['escritorio'] == 1) {
        ...
        $totalestudiantes = isset($regv->total_alumnos) ? $regv->total_alumnos : 0;
        $cap_almacen = 3000;
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <div class="box collapsed-box" style="background-color: <?php echo $color_seleccionado; ?>;">
                                            <div class="box-header with-border">
                                                <h3 class="box-title"><?php echo htmlspecialchars($nombre_grupo); ?></h3>
                                                ...
                                                <div class="box-tools pull-right">
                                                    <span data-toggle="tooltip" title="" class="badge" data-original-title="Cantidad de Estudiantes">
                                                        ...
                                                        while ($regrupo = $rsptag->fetch_object()) {
                                                            echo htmlspecialchars($regrupo->total_alumnos);
                                                        }
                                                        ?>
                                                    </span>
                                                ...
                                                <div class="direct-chat-messages">
                                                    ...
                                                    <div class="direct-chat-msg">
                                                        ...
                                                        while ($reg = $rsptas->fetch_object()) {
                                                            $image_src = empty($reg->image) ? 'anonymous.png' : $reg->image;
                                                            echo '<img class="img-circle" src="../files/articulos/' . htmlspecialchars($image_src) . '" height="50px" width="50px">';
                                                        }
                                                        ?>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="box-footer">
                                                <a href="vista_grupo.php?idgrupo=<?php echo htmlspecialchars($idgrupo); ?>" class="btn btn-default form-control">VER <i class="fa fa-arrow-circle-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
